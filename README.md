...
Se você quiser testar este projeto no seu computador, siga os passos abaixo:
...
* **Interface Web sem HTML/CSS**: Descobri como criar elementos complexos (botões, inputs e gráficos) usando apenas lógica Python com o framework Streamlit.
* **Versionamento com Git**: Pratiquei o fluxo de versionamento de código e a publicação de repositórios no GitHub.
* **Hospedagem na Nuvem**: Realizei o deploy de uma aplicação real utilizando o Streamlit Cloud, tornando o projeto acessível via URL pública.
